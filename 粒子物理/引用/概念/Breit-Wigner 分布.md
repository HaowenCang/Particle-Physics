...
> **通俗理解**：想象推一个秋千。如果你推的频率恰好等于秋千的固有频率，振幅会急剧增大——这就是共振。类似地，当碰撞质心能量恰好等于某个不稳定粒子的质量时，产生概率急剧增大。
...
> **通俗理解**：粒子存在的时间越短（$\tau$ 小），它的能量（质量）就越不确定（$\Gamma$ 大）——Breit-Wigner 的宽度就是这种不确定性的量化。
