...
> Klein-Gordon 方程中的"负能解"不是灾难，而是自然界告诉我们**必须存在反粒子**。电荷可以为正也可以为负——没有矛盾。
...
> Klein-Gordon 方程包含静止能量 $mc^2$ 的巨大振荡。把它"剥掉"之后，在动能远小于静止能量的条件下，剩下的慢变化部分满足薛定谔方程——薛定谔方程是 Klein-Gordon 方程的非相对论近似。
